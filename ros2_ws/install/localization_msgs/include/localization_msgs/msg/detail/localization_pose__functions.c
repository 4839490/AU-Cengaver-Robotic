...
localization_msgs__msg__LocalizationPose__init(localization_msgs__msg__LocalizationPose * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    localization_msgs__msg__LocalizationPose__fini(msg);
    return false;
  }
  // age_ms
  // valid_until_ms
...
localization_msgs__msg__LocalizationPose__create()
{
  ...
  localization_msgs__msg__LocalizationPose * msg = (localization_msgs__msg__LocalizationPose *)allocator.allocate(sizeof(localization_msgs__msg__LocalizationPose), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(localization_msgs__msg__LocalizationPose));
  bool success = localization_msgs__msg__LocalizationPose__init(msg);
  if (!success) {
...
localization_msgs__msg__LocalizationPose__Sequence__init(localization_msgs__msg__LocalizationPose__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  localization_msgs__msg__LocalizationPose * data = NULL;

  if (size) {
    data = (localization_msgs__msg__LocalizationPose *)allocator.zero_allocate(size, sizeof(localization_msgs__msg__LocalizationPose), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = localization_msgs__msg__LocalizationPose__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        localization_msgs__msg__LocalizationPose__fini(&data[i - 1]);
      }
...
localization_msgs__msg__LocalizationPose__Sequence__fini(localization_msgs__msg__LocalizationPose__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      localization_msgs__msg__LocalizationPose__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  localization_msgs__msg__LocalizationPose__Sequence * array = (localization_msgs__msg__LocalizationPose__Sequence *)allocator.allocate(sizeof(localization_msgs__msg__LocalizationPose__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = localization_msgs__msg__LocalizationPose__Sequence__init(array, size);
  if (!success) {
...
localization_msgs__msg__LocalizationPose__Sequence__destroy(localization_msgs__msg__LocalizationPose__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    localization_msgs__msg__LocalizationPose__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
localization_msgs__msg__LocalizationPose__Sequence__are_equal(const localization_msgs__msg__LocalizationPose__Sequence * lhs, const localization_msgs__msg__LocalizationPose__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!localization_msgs__msg__LocalizationPose__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  localization_msgs__msg__LocalizationPose__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(localization_msgs__msg__LocalizationPose);
    localization_msgs__msg__LocalizationPose * data =
      (localization_msgs__msg__LocalizationPose *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!localization_msgs__msg__LocalizationPose__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          localization_msgs__msg__LocalizationPose__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!localization_msgs__msg__LocalizationPose__copy(
