...
#include <stddef.h>
#include "planning_msgs/msg/detail/trajectory__rosidl_typesupport_introspection_c.h"
...
// Member `points`
#include "planning_msgs/msg/trajectory_point.h"
// Member `points`
#include "planning_msgs/msg/detail/trajectory_point__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  planning_msgs__msg__Trajectory__init(message_memory);
}

void Trajectory__rosidl_typesupport_introspection_c__Trajectory_fini_function(void * message_memory)
{
  planning_msgs__msg__Trajectory__fini(message_memory);
}

size_t Trajectory__rosidl_typesupport_introspection_c__size_function__TrajectoryPoint__points(
  const void * untyped_member)
{
  const planning_msgs__msg__TrajectoryPoint__Sequence * member =
    (const planning_msgs__msg__TrajectoryPoint__Sequence *)(untyped_member);
  return member->size;
}
...
{
  planning_msgs__msg__TrajectoryPoint__Sequence * member =
    (planning_msgs__msg__TrajectoryPoint__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  planning_msgs__msg__TrajectoryPoint__Sequence * member =
    (planning_msgs__msg__TrajectoryPoint__Sequence *)(untyped_member);
  planning_msgs__msg__TrajectoryPoint__Sequence__fini(member);
  return planning_msgs__msg__TrajectoryPoint__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember Trajectory__rosidl_typesupport_introspection_c__Trajectory_message_member_array[6] = {
  {
    "header",  // name
    ...
    offsetof(planning_msgs__msg__Trajectory, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planning_msgs__msg__Trajectory, points),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planning_msgs__msg__Trajectory, planner_mode),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planning_msgs__msg__Trajectory, valid_until_ms),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planning_msgs__msg__Trajectory, age_ms),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planning_msgs__msg__Trajectory, warning_flags),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Trajectory__rosidl_typesupport_introspection_c__Trajectory_message_members = {
  ...
  6,  // number of fields
  sizeof(planning_msgs__msg__Trajectory),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, planning_msgs, msg, Trajectory)() {
  ...
  Trajectory__rosidl_typesupport_introspection_c__Trajectory_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, planning_msgs, msg, TrajectoryPoint)();
