...
#ifndef PLANNING_MSGS__MSG__DETAIL__TRAJECTORY_POINT__FUNCTIONS_H_
#define PLANNING_MSGS__MSG__DETAIL__TRAJECTORY_POINT__FUNCTIONS_H_
 ...
 * calls
 * planning_msgs__msg__TrajectoryPoint__init().
...
/**
 * It calls
 * planning_msgs__msg__TrajectoryPoint__fini()
 ...
 * planning_msgs__msg__TrajectoryPoint__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * planning_msgs__msg__TrajectoryPoint__Sequence__fini()
 * on the array,
...
#endif  // PLANNING_MSGS__MSG__DETAIL__TRAJECTORY_POINT__FUNCTIONS_H_
