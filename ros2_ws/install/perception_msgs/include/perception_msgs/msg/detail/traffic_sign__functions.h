...
#ifndef PERCEPTION_MSGS__MSG__DETAIL__TRAFFIC_SIGN__FUNCTIONS_H_
#define PERCEPTION_MSGS__MSG__DETAIL__TRAFFIC_SIGN__FUNCTIONS_H_
 ...
 * calls
 * perception_msgs__msg__TrafficSign__init().
...
/**
 * It calls
 * perception_msgs__msg__TrafficSign__fini()
 ...
 * perception_msgs__msg__TrafficSign__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * perception_msgs__msg__TrafficSign__Sequence__fini()
 * on the array,
...
#endif  // PERCEPTION_MSGS__MSG__DETAIL__TRAFFIC_SIGN__FUNCTIONS_H_
