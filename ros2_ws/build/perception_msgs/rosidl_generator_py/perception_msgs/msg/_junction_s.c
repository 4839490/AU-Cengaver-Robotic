...
bool perception_msgs__msg__junction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("perception_msgs.msg._junction.Junction", full_classname_dest, 38) == 0);
  }
  perception_msgs__msg__Junction * ros_message = _ros_message;
  {  // header
  ...
  {  // arm_count
    PyObject * field = PyObject_GetAttrString(_pymsg, "arm_count");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->arm_count = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // distance_to_entry
    PyObject * field = PyObject_GetAttrString(_pymsg, "distance_to_entry");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->distance_to_entry = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // confidence
...
{
  /* NOTE(esteve): Call constructor of Junction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_msgs.msg._junction");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Junction");
  ...
  {  // arm_count
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->arm_count);
    {
      int rc = PyObject_SetAttrString(_pymessage, "arm_count", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // distance_to_entry
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->distance_to_entry);
    {
      int rc = PyObject_SetAttrString(_pymessage, "distance_to_entry", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
