...
#include "perception_msgs/msg/detail/junction__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const perception_msgs::msg::Junction & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  perception_msgs::msg::Junction & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const perception_msgs::msg::Junction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<perception_msgs::msg::Junction *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Junction__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const perception_msgs::msg::Junction *>(
...
{
  return max_serialized_size_Junction(full_bounded, 0);
}

static message_type_support_callbacks_t _Junction__callbacks = {
  "perception_msgs::msg",
  "Junction",
...
static rosidl_message_type_support_t _Junction__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Junction__callbacks,
...
{
  return &perception_msgs::msg::typesupport_fastrtps_cpp::_Junction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_msgs, msg, Junction)() {
  return &perception_msgs::msg::typesupport_fastrtps_cpp::_Junction__handle;
}
