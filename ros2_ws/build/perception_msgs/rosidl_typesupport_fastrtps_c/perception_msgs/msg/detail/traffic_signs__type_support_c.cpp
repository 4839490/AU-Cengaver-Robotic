...
#include "perception_msgs/msg/detail/traffic_signs__rosidl_typesupport_fastrtps_c.h"
...
#include "perception_msgs/msg/detail/traffic_sign__functions.h"  // signs
...
using _TrafficSigns__ros_msg_type = perception_msgs__msg__TrafficSigns;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: signs
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, perception_msgs, msg, TrafficSign
      )()->data);
    size_t size = ros_message->signs.size;
    auto array_ptr = ros_message->signs.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: signs
  {
    ...
    if (ros_message->signs.data) {
      perception_msgs__msg__TrafficSign__Sequence__fini(&ros_message->signs);
    }
    if (!perception_msgs__msg__TrafficSign__Sequence__init(&ros_message->signs, size)) {
      return "failed to create array for field 'signs'";
    }
    auto array_ptr = ros_message->signs.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
size_t get_serialized_size_perception_msgs__msg__TrafficSigns(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrafficSigns__ros_msg_type * ros_message = static_cast<const _TrafficSigns__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name signs
  {
    size_t array_size = ros_message->signs.size;
    auto array_ptr = ros_message->signs.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);

    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_perception_msgs__msg__TrafficSign(
...
static uint32_t _TrafficSigns__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_perception_msgs__msg__TrafficSigns(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_perception_msgs
size_t max_serialized_size_perception_msgs__msg__TrafficSigns(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: signs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_perception_msgs__msg__TrafficSign(
        full_bounded, current_alignment);
    }
  }
...
static size_t _TrafficSigns__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_perception_msgs__msg__TrafficSigns(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, perception_msgs, msg, TrafficSigns)() {
