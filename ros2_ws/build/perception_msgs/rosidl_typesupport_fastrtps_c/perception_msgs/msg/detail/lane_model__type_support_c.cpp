...
#include "perception_msgs/msg/detail/lane_model__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // centerline, left_boundary, right_boundary
...
using _LaneModel__ros_msg_type = perception_msgs__msg__LaneModel;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LaneModel__ros_msg_type * ros_message = static_cast<const _LaneModel__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: lane_width_estimate
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LaneModel__ros_msg_type * ros_message = static_cast<_LaneModel__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: centerline
  {
    ...
    if (ros_message->centerline.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->centerline);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->centerline, size)) {
      return "failed to create array for field 'centerline'";
    }
    auto array_ptr = ros_message->centerline.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: left_boundary
  {
    ...
    if (ros_message->left_boundary.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->left_boundary);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->left_boundary, size)) {
      return "failed to create array for field 'left_boundary'";
    }
    auto array_ptr = ros_message->left_boundary.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: right_boundary
  {
    ...
    if (ros_message->right_boundary.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->right_boundary);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->right_boundary, size)) {
      return "failed to create array for field 'right_boundary'";
    }
    auto array_ptr = ros_message->right_boundary.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
size_t get_serialized_size_perception_msgs__msg__LaneModel(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LaneModel__ros_msg_type * ros_message = static_cast<const _LaneModel__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LaneModel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_perception_msgs__msg__LaneModel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_perception_msgs
size_t max_serialized_size_perception_msgs__msg__LaneModel(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_perception_msgs__msg__LaneModel(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_LaneModel = {
  "perception_msgs::msg",
  "LaneModel",
...
static rosidl_message_type_support_t _LaneModel__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LaneModel,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, perception_msgs, msg, LaneModel)() {
  return &_LaneModel__type_support;
}
