...
#include "planning_msgs/msg/detail/park_complete__rosidl_typesupport_fastrtps_c.h"
...
using _ParkComplete__ros_msg_type = planning_msgs__msg__ParkComplete;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ParkComplete__ros_msg_type * ros_message = static_cast<const _ParkComplete__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: final_cross_track_error
  {
    cdr << ros_message->final_cross_track_error;
  }

  // Field name: final_heading_error
  {
    cdr << ros_message->final_heading_error;
  }

  // Field name: iterations_used
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ParkComplete__ros_msg_type * ros_message = static_cast<_ParkComplete__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_planning_msgs__msg__ParkComplete(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ParkComplete__ros_msg_type * ros_message = static_cast<const _ParkComplete__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ParkComplete__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_planning_msgs__msg__ParkComplete(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_planning_msgs
size_t max_serialized_size_planning_msgs__msg__ParkComplete(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_planning_msgs__msg__ParkComplete(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ParkComplete = {
  "planning_msgs::msg",
  "ParkComplete",
...
static rosidl_message_type_support_t _ParkComplete__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ParkComplete,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, planning_msgs, msg, ParkComplete)() {
  return &_ParkComplete__type_support;
}
