...
#include "planning_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const planning_msgs::msg::TrajectoryPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  planning_msgs::msg::TrajectoryPoint &);
size_t get_serialized_size(
  const planning_msgs::msg::TrajectoryPoint &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const planning_msgs::msg::Trajectory & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: points
  {
    ...
    for (size_t i = 0; i < size; i++) {
      planning_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  planning_msgs::msg::Trajectory & ros_message)
{
  // Member: header
  ...
  // Member: points
  {
    ...
    for (size_t i = 0; i < size; i++) {
      planning_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        planning_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrajectoryPoint(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const planning_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<planning_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &planning_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, planning_msgs, msg, Trajectory)() {
  return &planning_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
