...
#include "planning_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const planning_msgs::msg::TrajectoryPoint & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: distance_from_start
  cdr << ros_message.distance_from_start;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  planning_msgs::msg::TrajectoryPoint & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  // Member: distance_from_start
  {
    size_t item_size = sizeof(ros_message.distance_from_start);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const planning_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<planning_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
get_message_type_support_handle<planning_msgs::msg::TrajectoryPoint>()
{
  return &planning_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, planning_msgs, msg, TrajectoryPoint)() {
  return &planning_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
