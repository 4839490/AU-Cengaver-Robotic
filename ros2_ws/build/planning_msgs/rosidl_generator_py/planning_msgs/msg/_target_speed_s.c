...
bool planning_msgs__msg__target_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("planning_msgs.msg._target_speed.TargetSpeed", full_classname_dest, 43) == 0);
  }
  planning_msgs__msg__TargetSpeed * ros_message = _ros_message;
  {  // header
  ...
  {  // jerk_limit
    ...
    assert(PyFloat_Check(field));
    ros_message->jerk_limit = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // reason
...
{
  /* NOTE(esteve): Call constructor of TargetSpeed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("planning_msgs.msg._target_speed");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TargetSpeed");
