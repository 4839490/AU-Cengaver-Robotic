...
bool planning_msgs__msg__goal_reached__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("planning_msgs.msg._goal_reached.GoalReached", full_classname_dest, 43) == 0);
  }
  planning_msgs__msg__GoalReached * ros_message = _ros_message;
  {  // header
  ...
  {  // waypoint_type
    ...
    assert(PyLong_Check(field));
    ros_message->waypoint_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // success
  ...
  {  // distance_error
    ...
    ros_message->distance_error = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // heading_error
...
{
  /* NOTE(esteve): Call constructor of GoalReached */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("planning_msgs.msg._goal_reached");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GoalReached");
  ...
  {  // waypoint_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->waypoint_type);
    {
