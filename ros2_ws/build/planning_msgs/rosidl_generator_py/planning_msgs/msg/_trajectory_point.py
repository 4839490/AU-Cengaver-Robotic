...
class TrajectoryPoint(metaclass=Metaclass_TrajectoryPoint):
    ...
    def __init__(self, **kwargs):
        ...
        self.distance_from_start = kwargs.get('distance_from_start', float())
    ...
    def __eq__(self, other):
        ...
        if self.curvature != other.curvature:
            return False
        if self.distance_from_start != other.distance_from_start:
            return False
        return True
    ...
    def distance_from_start(self):
        """Message field 'distance_from_start'."""
        return self._distance_from_start

    @distance_from_start.setter
    def distance_from_start(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'distance_from_start' field must be of type 'float'"
