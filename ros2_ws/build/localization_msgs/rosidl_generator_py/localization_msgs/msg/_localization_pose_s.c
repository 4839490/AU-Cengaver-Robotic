...
bool localization_msgs__msg__localization_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("localization_msgs.msg._localization_pose.LocalizationPose", full_classname_dest, 57) == 0);
  }
  localization_msgs__msg__LocalizationPose * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LocalizationPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("localization_msgs.msg._localization_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LocalizationPose");
