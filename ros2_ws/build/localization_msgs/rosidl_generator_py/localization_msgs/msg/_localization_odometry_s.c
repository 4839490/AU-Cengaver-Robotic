...
bool localization_msgs__msg__localization_odometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("localization_msgs.msg._localization_odometry.LocalizationOdometry", full_classname_dest, 65) == 0);
  }
  localization_msgs__msg__LocalizationOdometry * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LocalizationOdometry */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("localization_msgs.msg._localization_odometry");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LocalizationOdometry");
