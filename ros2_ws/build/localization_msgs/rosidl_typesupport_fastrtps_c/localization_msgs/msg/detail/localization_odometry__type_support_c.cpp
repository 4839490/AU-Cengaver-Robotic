...
#include "localization_msgs/msg/detail/localization_odometry__rosidl_typesupport_fastrtps_c.h"
...
using _LocalizationOdometry__ros_msg_type = localization_msgs__msg__LocalizationOdometry;

static bool _LocalizationOdometry__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LocalizationOdometry__ros_msg_type * ros_message = static_cast<const _LocalizationOdometry__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _LocalizationOdometry__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _LocalizationOdometry__ros_msg_type * ros_message = static_cast<_LocalizationOdometry__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_localization_msgs__msg__LocalizationOdometry(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LocalizationOdometry__ros_msg_type * ros_message = static_cast<const _LocalizationOdometry__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LocalizationOdometry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_localization_msgs__msg__LocalizationOdometry(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_localization_msgs
size_t max_serialized_size_localization_msgs__msg__LocalizationOdometry(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _LocalizationOdometry__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_localization_msgs__msg__LocalizationOdometry(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_LocalizationOdometry = {
  "localization_msgs::msg",
  "LocalizationOdometry",
  _LocalizationOdometry__cdr_serialize,
  _LocalizationOdometry__cdr_deserialize,
  _LocalizationOdometry__get_serialized_size,
  _LocalizationOdometry__max_serialized_size
};

static rosidl_message_type_support_t _LocalizationOdometry__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LocalizationOdometry,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, localization_msgs, msg, LocalizationOdometry)() {
  return &_LocalizationOdometry__type_support;
}
