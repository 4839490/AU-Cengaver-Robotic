...
#include "localization_msgs/msg/detail/localization_status__rosidl_typesupport_fastrtps_c.h"
...
using _LocalizationStatus__ros_msg_type = localization_msgs__msg__LocalizationStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: map_odom_drift
  {
    cdr << ros_message->map_odom_drift;
  }

  // Field name: gps_available
  {
...
size_t get_serialized_size_localization_msgs__msg__LocalizationStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LocalizationStatus__ros_msg_type * ros_message = static_cast<const _LocalizationStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LocalizationStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_localization_msgs__msg__LocalizationStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_localization_msgs
size_t max_serialized_size_localization_msgs__msg__LocalizationStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_localization_msgs__msg__LocalizationStatus(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, localization_msgs, msg, LocalizationStatus)() {
