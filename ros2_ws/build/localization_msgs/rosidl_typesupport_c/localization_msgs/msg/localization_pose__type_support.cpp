...
static const _LocalizationPose_type_support_symbol_names_t _LocalizationPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, localization_msgs, msg, LocalizationPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, localization_msgs, msg, LocalizationPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, localization_msgs, msg, LocalizationPose)() {
  return &::localization_msgs::msg::rosidl_typesupport_c::LocalizationPose_message_type_support_handle;
}
