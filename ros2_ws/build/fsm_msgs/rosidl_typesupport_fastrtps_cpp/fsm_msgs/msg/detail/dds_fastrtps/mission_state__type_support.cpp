...
#include "fsm_msgs/msg/detail/mission_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fsm_msgs::msg::MissionState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fsm_msgs::msg::MissionState & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const fsm_msgs::msg::MissionState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fsm_msgs::msg::MissionState *>(
    untyped_ros_message);
...
{
  return max_serialized_size_MissionState(full_bounded, 0);
}
...
{
  return &fsm_msgs::msg::typesupport_fastrtps_cpp::_MissionState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsm_msgs, msg, MissionState)() {
  return &fsm_msgs::msg::typesupport_fastrtps_cpp::_MissionState__handle;
}
