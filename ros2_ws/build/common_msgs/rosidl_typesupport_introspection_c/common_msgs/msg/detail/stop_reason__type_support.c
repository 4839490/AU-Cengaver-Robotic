...
#include <stddef.h>
#include "common_msgs/msg/detail/stop_reason__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  common_msgs__msg__StopReason__init(message_memory);
}

void StopReason__rosidl_typesupport_introspection_c__StopReason_fini_function(void * message_memory)
{
  common_msgs__msg__StopReason__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember StopReason__rosidl_typesupport_introspection_c__StopReason_message_member_array[1] = {
  {
    "reason",  // name
    ...
    offsetof(common_msgs__msg__StopReason, reason),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers StopReason__rosidl_typesupport_introspection_c__StopReason_message_members = {
  ...
  1,  // number of fields
  sizeof(common_msgs__msg__StopReason),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, common_msgs, msg, StopReason)() {
